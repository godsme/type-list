...
namespace {
    ...
    SCENARIO("Transform ValueToValue") {
        using type = __TL_Map(Add, __TL_list(1, 2, 3));
    ...
    SCENARIO("Transform ValueToType") {
        using type = __TL_Map(ToType, __TL_list(1, 2, 3));
    ...
    SCENARIO("Transform Type2Type") {
        using type = __TL_Map(Wrap, __TL_list(int, double));
    ...
    SCENARIO("Transform Type2Value") {
        using type = __TL_Map(IntTrait, __TL_list(int, double));
